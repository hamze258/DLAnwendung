...
def evaluate_model(model, env, n_episodes=100, max_steps=10000):
    ...
    for ep in range(n_episodes):
        ...
        while not done and step_counter < max_steps:
            ...
            total_score = score  # Update des Scores
...
# ----------------------------------------------------
# Hauptteil: Auswahl und Plotting eines Modells
# ----------------------------------------------------
if __name__ == "__main__":
    # ------------------------------------------------------------
    # Auswahl des zu plottenden Algorithmus
    # ------------------------------------------------------------
    selected_algorithm = 'PPO'  # Ändere zu 'PPO', um PPO zu plotten
    ...
    # ------------------------------------------------------------
    save_dir = os.path.join("vector_env", "evaluation", "reward2", "metriken3")
    os.makedirs(save_dir, exist_ok=True)

    # ------------------------------------------------------------
    # Environment erstellen (ggf. mit render=False)
    # ------------------------------------------------------------
    ...
    # ------------------------------------------------------------
    # Anzahl der Episoden für den Vergleich
    # ------------------------------------------------------------
    ...
    # ------------------------------------------------------------
    # DataFrame für Plotly (Scores und Rewards pro Episode)
    # ------------------------------------------------------------
    df = pd.DataFrame({
    ...
    # ------------------------------------------------------------
    # Plot 1: Boxplot (Score-Verteilung)
    # ------------------------------------------------------------
    fig_box = go.Figure()
    ...
    # ------------------------------------------------------------
    # Plot 2: Boxplot (Reward-Verteilung)
    # ------------------------------------------------------------
