...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------
    save_dir = os.path.join("vector_env", "evaluation", "reward3", "metriken1")
    ...
    model_dqn1 = DQN.load(r"vector_env\models\DQN\training8\best_model.zip")
    model_ppo1 = PPO.load(r"vector_env\models\PPO\training16\best_model.zip")
