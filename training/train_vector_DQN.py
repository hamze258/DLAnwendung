...
vec_env = SubprocVecEnv([lambda: FlappyBirdEnv()])

# 3. Evaluationsumgebung erzeugen
eval_env = SubprocVecEnv([lambda: FlappyBirdEnv()])
...
# 10. Modell speichern
model.save("dqn_flappy_bird_final_ImgEnv")
